...
const ar: Dict = {
  ...
  'cars.sort': 'ترتيب',
  'cars.sort_urgency': 'الإلحاح',
  'cars.sort_name': 'الاسم',
  'cars.sort_mileage': 'العداد',
  ...
  'cardetails.info_title': 'بيانات السيارة',
  'cardetails.info_make': 'الماركة',
  'cardetails.info_model': 'الموديل',
  'cardetails.info_year': 'سنة الصنع',
  'cardetails.info_color': 'اللون',
  'cardetails.info_odometer': 'العداد الحالي',
  'cardetails.intervals_title': 'فواصل الصيانة',
  'cardetails.interval_oil': 'الزيت كل',
  'cardetails.interval_battery': 'البطارية كل',
  'cardetails.interval_tires': 'الإطارات كل',
  'cardetails.interval_maintenance': 'الصيانة كل',
  'cardetails.interval_months': '{n} شهر',
  'cardetails.interval_unset': 'غير محدّد',
  'cardetails.edit_intervals': 'تعديل',
  'cardetails.history_empty': 'لا توجد سجلات لهذه السيارة بعد',
  'cardetails.history_view_all': 'عرض في السجل الكامل',
  'cardetails.danger_title': 'منطقة خطر',
  'cardetails.delete_vehicle': 'حذف السيارة',
  ...
  'settings.section_data': 'البيانات',
  'settings.section_about': 'حول التطبيق',
  'settings.notifications': 'التنبيهات',
  'settings.notifications_sub': 'تذكيرات الصيانة والفحص',
  'settings.units': 'الوحدات',
  'settings.units_sub': 'كم · لتر · ريال',
  'settings.language': 'اللغة',
  'settings.backup': 'نسخة احتياطية',
  'settings.backup_sub': 'محفوظة مع Google',
  'settings.backup_synced': 'محدّث',
  'settings.privacy': 'الخصوصية',
  'settings.privacy_sub': 'بياناتك على جهازك فقط',
  'settings.export': 'تصدير البيانات',
  'settings.export_sub': 'PDF · CSV',
  'settings.version': 'الإصدار',
  'settings.version_sub': 'v2.0',
  'settings.rate': 'قيّم التطبيق',
  'settings.signed_in_with': 'Google',
...
const en: Dict = {
  ...
  'cars.sort': 'Sort',
  'cars.sort_urgency': 'Urgency',
  'cars.sort_name': 'Name',
  'cars.sort_mileage': 'Mileage',
  ...
  'cardetails.info_title': 'Car info',
  'cardetails.info_make': 'Make',
  'cardetails.info_model': 'Model',
  'cardetails.info_year': 'Year',
  'cardetails.info_color': 'Color',
  'cardetails.info_odometer': 'Current odometer',
  'cardetails.intervals_title': 'Service intervals',
  'cardetails.interval_oil': 'Oil every',
  'cardetails.interval_battery': 'Battery every',
  'cardetails.interval_tires': 'Tires every',
  'cardetails.interval_maintenance': 'Service every',
  'cardetails.interval_months': '{n} months',
  'cardetails.interval_unset': 'Not set',
  'cardetails.edit_intervals': 'Edit',
  'cardetails.history_empty': 'No entries for this car yet',
  'cardetails.history_view_all': 'View in full timeline',
  'cardetails.danger_title': 'Danger zone',
  'cardetails.delete_vehicle': 'Delete car',
  ...
  'settings.notifications_sub': 'Service & inspection reminders',
  'settings.units': 'Units',
  'settings.units_sub': 'km · L · SAR',
  'settings.language': 'Language',
  'settings.backup': 'Backup',
  'settings.backup_sub': 'Saved with Google',
  'settings.backup_synced': 'Synced',
  'settings.privacy': 'Privacy',
  'settings.privacy_sub': 'Your data stays on your device',
  'settings.export': 'Export data',
  'settings.export_sub': 'PDF · CSV',
  'settings.version': 'Version',
  'settings.version_sub': 'v2.0',
  'settings.rate': 'Rate MOTR',
  'settings.signed_in_with': 'Google',
